        ...
        <table>
            ...
            <tbody>
                ...
                while ($arr = mysqli_fetch_array($result)) {
                    echo "<tr>
                                <td><span>" . $arr['id_admin'] . "</span></td>
                                <td><span>" . $arr['name'] . "</span></td>
                                <td><span>" . $arr['email'] . "</span></td>
                                <td><span>" . mb_strimwidth($arr['address'],0,20,"...") . "</span> </td>
                                <td><span>" . $arr['phone'] . "</span> </td>
                                <td><a href='delete-admin.php?id= " . $arr['id_admin'] . "' class='delete'>delete</a> </td>
                                <td><a href='update-admin.php?id= " . $arr['id_admin'] . "' class='update'>update</a> </td>
                            </tr>";
                }
                ?>
            </tbody>
